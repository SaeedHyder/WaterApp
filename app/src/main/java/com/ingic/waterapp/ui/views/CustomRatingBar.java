...
public class CustomRatingBar extends LinearLayout {
    ...
    private int mStarOnResource = R.drawable.star_selected;
    private int mStarOffResource = R.drawable.star_unselected;
    private int mStarHalfResource = R.drawable.star_selected;
